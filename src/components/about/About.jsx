...
import CV from "../../assets/Suryamani-kumar.pdf";
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            ...
            infrastructure, and managing seamless application deployment.
            Committed to driving Continuous Integration and Continuous Delivery
            in dynamic environments. Eager to apply technical skills to
